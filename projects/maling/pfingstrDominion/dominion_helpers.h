...
int refactoredMinion(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos);
int refactoredTribute(struct gameState *state, int currentPlayer);
int refactoredAmbassador(struct gameState *state, int choice1, int choice2, int currentPlayer, int handPos);
